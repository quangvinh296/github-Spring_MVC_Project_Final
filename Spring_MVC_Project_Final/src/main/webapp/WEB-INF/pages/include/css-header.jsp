...
<link rel="stylesheet" href="<c:url value="/resources/1/css/linearicons.css"/>"/>
<link rel="stylesheet" href="<c:url value="/resources/1/css/owl.carousel.css"/>"/>            
<link rel="stylesheet" href="<c:url value="/resources/1/css/font-awesome.min.css"/>"/>
<link rel="stylesheet" href="<c:url value="/resources/1/css/nice-select.css"/>"/>
<link rel="stylesheet" href="<c:url value="/resources/1/css/ion.rangeSlider.css"/>"/>
<link rel="stylesheet" href="<c:url value="/resources/1/css/ion.rangeSlider.skinFlat.css"/>"/>
<link rel="stylesheet" href="<c:url value="/resources/1/css/bootstrap.css"/>"/>