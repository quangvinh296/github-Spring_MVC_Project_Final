...
(function ($, window, document, undefined) {
    ...
    TwbsPagination.prototype = {
        ...
        makeHref: function (page) {
            return this.options.href ? this.generateQueryString(page) : "${pageContext.request.contextPath}/listProduct/${page}";
        },
        ...
        getPageFromQueryString: function (searchStr) {
            var search = this.getSearchString(searchStr),
                regex = new RegExp(this.options.pageVariable + '(=([^&${pageContext.request.contextPath}/listProduct]*)|&|${pageContext.request.contextPath}/listProduct|$)'),
        ...
        generateQueryString: function (pageNumber, searchStr) {
            var search = this.getSearchString(searchStr),
                regex = new RegExp(this.options.pageVariable + '=*[^&${pageContext.request.contextPath}/listProduct]*');
            if (!search) return '';
